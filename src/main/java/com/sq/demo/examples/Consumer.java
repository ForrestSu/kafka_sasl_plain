...
public class Consumer extends ShutdownableThread {
    ...
    public Consumer(String topic, Properties props) {
        ...
        consumer = new KafkaConsumer<>(props, null, new BytesDeserializer());
        this.topic = topic;
    }
    ...
    public void doWork() {
        ...
        while(true) {
            ...
            for (ConsumerRecord<String, byte[]> record : records) {
                System.out.println("Received message: (" + record.key()+ ", length is " + record.value().length+ ") at offset " + record.offset());
